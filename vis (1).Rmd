...
Ensuite, on commence par la partie client, notre interface contiendra 2 partie, la partie gauche contient les inputs ou l'utilisateur pourra choisir le fihier, on affiche les statistiques de la fonction, les cordonnées.
